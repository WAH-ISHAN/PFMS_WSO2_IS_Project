      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-gray-200/60 dark:border-gray-700 bg-white/80 dark:bg-gray-900/60 backdrop-blur shadow-xl p-8">
          <div className="text-center mb-6">
            <h2 className="text-3xl font-semibold text-gray-900 dark:text-white">Verify OTP</h2>
            <p className="mt-1 text-gray-600 dark:text-gray-300">Enter the code sent to your email</p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div>
              <label htmlFor="otp" className="block text-sm font-medium text-gray-700 dark:text-gray-200">OTP</label>
              <div className="relative mt-1">
                <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                  <svg className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <input
                  ...
                  pattern="[0-9]*"
                  maxLength={6}
                  className="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white/70 dark:bg-gray-800/70 px-3 py-2 pl-10 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-gray-100 tracking-widest"
                  placeholder="######"
                  value={otp}
              ...
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">6-digit code</p>
            </div>
                ...
                >
                  {showPwd ? (
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 3l18 18M3.98 8.223A10.477 10.477 0 002.036 12c1.6 4.133 5.403 7.5 9.964 7.5 1.719 0 3.347-.437 4.76-1.205M6.228 6.228A10.45 10.45 0 0112 4.5c4.561 0 8.364 3.367 9.964 7.5a10.523 10.523 0 01-4.292 5.032" />
                    </svg>
                  ) : (
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M2.036 12.322a1.012 1.012 0 010-.644C3.423 7.51 7.36 4.5 12 4.5c4.64 0 8.577 3.01 9.964 7.178.07.201.07.443 0 .644C20.577 16.49 16.64 19.5 12 19.5c-4.64 0-8.577-3.01-9.964-7.178z" />
